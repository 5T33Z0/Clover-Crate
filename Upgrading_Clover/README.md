...
|---------|-----------|-----|
|<ul><li>**`AptioMemoryFix.efi`**<li>**`OsxAptioFixDrv.efi`**<li>**`OsxAptioFix2Drv-free2000`**<li> **`OsxAptioFix3Drv.efi`**<li>**`OsxLowMemFixDrv`**<li>**`OcQuirks.efi`** and **`OcQuirks.plist`**|Obsolete **Aptio Memory Fixes** and OCQuirks. [OcQuirks](https://github.com/ReddestDream/OcQuirks) is a relic from earlier attempts to include OpenCore Booter Quirks into Clover (≤ r5122). | Delete
