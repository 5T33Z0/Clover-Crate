...
**`SMCHelper.efi`** | Deprecated since r5148, [Commit 735987a](https://www.insanelymac.com/forum/topic/304530-clover-change-explanations/?do=findComment&comment=2789856). Its functionality is now embedded in Clover. This change also brought a new "ResetSMC" option to the Clover Boot Menu which works similar to the SMC Reset on real Macs.| Delete
